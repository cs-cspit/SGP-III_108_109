...
import { 
  ...
  FaBell, FaChartLine, FaCamera, FaClock
} from 'react-icons/fa';
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <FaCamera className="h-8 w-8 text-orange-600" />
            </div>
            <div className="ml-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
              <div className="flex items-center">
                ...
                <span className="text-sm font-medium text-yellow-800">Pending Bookings</span>
              </div>
            ...
            <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
              <div className="flex items-center">
                ...
                <span className="text-sm font-medium text-blue-800">Today's Bookings</span>
              </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-3">
            {stats.alerts.lowStock.slice(0, 5).map((item) => (
              <div key={item._id} className="flex justify-between items-center p-3 border rounded-lg border-red-200 bg-red-50">
                <div>
